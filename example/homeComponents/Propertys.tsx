...
import ilustrate1 from   '../../public/assets/ilustrate1.webp'
import ilustrate2 from   '../../public/assets/ilustrate2.webp'
import ilustrate3 from   '../../public/assets/ilustrate3.webp'
function Propertys() {
  ...
  return (
    ...
    <h1 className=' mt-20 mb-10 text-slate-500  text-center text-3xl'> ویژگی های یادینا
        ...
        <h1 className=' container text-center mx-0   mb-6  text-slate-500 text-xl '>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است </h1>
