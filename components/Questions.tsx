    ...
    <div dir="rtl" className='flex flex-col text-center gap-3 rounded-md items-center justify-center  relative md:ml-56 ml-20  w-4/6'>
      ...
      <Accordion className='rounded-lg border-none ' expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary className='bg-white'  aria-controls="panel1d-content" id="panel1d-header">
          <Typography >  چرا باید یادینا را انتخاب کنیم؟</Typography>
        </AccordionSummary> 
        <AccordionDetails>
          <Typography>
      ...
      <Accordion className='rounded-lg border-none'   expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
      ...
      <Accordion className='rounded-lg border-none'  expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary className='bg-white' aria-controls="panel3d-content" id="panel3d-header">
          <Typography> چرا باید یادینا را انتخاب کنیم</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
